...
//desacoplar a funçao do foreach 
...
youtubeUser.metodoExibe()


/*Resumo:
Dentro de um método: Use this.about.description.
Fora de um método: Use youtubeUser.about.description.
*/
/*
  03
...
console.log(Math.round(numeroAleatorio *50))